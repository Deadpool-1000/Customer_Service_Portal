...
class HelpDeskTicketSection:
    ...
    def view_ticket_detail_handler(self, all_tickets):
        ...
        if found_ticket[0].status == HelpdeskTicketConfig.IN_PROGRESS:
            ...
            user_choice = simple_prompt(HelpdeskTicketConfig.IN_PROGRESS_DETAILS_PROMPT, allowed=('c', 'q'))
            if user_choice == 'c':
            ...
            user_choice = simple_prompt(HelpdeskTicketConfig.RAISED_TICKETS_DETAIL_PROMPT, allowed=('r', 'q'))
            if user_choice == 'r':
            ...
            _ = simple_prompt(HelpdeskTicketConfig.GO_BACK_PROMPT, allowed=['q'])
            return
